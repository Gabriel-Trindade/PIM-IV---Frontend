...
import updateFuncionario from "../../hooks/useUpdateFuncionarios";
import { DesktopDatePicker } from "@mui/x-date-pickers";
import { format, parse, isValid } from "date-fns";
import { utcToZonedTime } from "date-fns-tz";

export const EditFunc = ({ funcionario, onClose }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      dataNascimento: formatData(funcionario.dataNascimento),
      dtAdmissao: formatData(funcionario.dtAdmissao),
      submit: null,
    },
    ...
    onSubmit: async (values, helpers) => {
      try {
        ...
        helpers.setErrors({ submit: "Funcionario atualizado com sucesso!" });
