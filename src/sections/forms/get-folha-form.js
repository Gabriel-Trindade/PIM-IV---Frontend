...
export const GetFolhaPagamento = ({ folha, onClose }) => {
  ...
  return (
    <form noValidate onSubmit={formik.handleSubmit}>
      <Card>
        <CardHeader
          subheader="Visualização da folha de pagamento"
          title="Informações da folha de pagamento preenchida para o funcionário."
        />
        <CardContent sx={{ pt: 0 }}>
          <Box sx={{ m: -1.5 }}>
            <Grid container spacing={3}>
              ...
              <Grid xs={12} md={6}>
                <TextField
                  ...
                  onBlur={formik.handleBlur}
                  onChange={formik.handleChange}
                  value={formatData(folha.data_vigencia)}         
                />
              </Grid>
